...
const CAPABILITIES: Record<BlockKind, BlockCapability> = {
  paragraph: { canAlign: true, inlineFormats: ALL_INLINE },
  h1: { canAlign: true, inlineFormats: HEADING_INLINE },
  h2: { canAlign: true, inlineFormats: HEADING_INLINE },
  h3: { canAlign: true, inlineFormats: HEADING_INLINE },
  h4: { canAlign: true, inlineFormats: HEADING_INLINE },
  h5: { canAlign: true, inlineFormats: HEADING_INLINE },
  h6: { canAlign: true, inlineFormats: HEADING_INLINE },
  bullet: { canAlign: false, inlineFormats: ALL_INLINE },
  number: { canAlign: false, inlineFormats: ALL_INLINE },
  check: { canAlign: false, inlineFormats: ALL_INLINE },
  // Quote and callout are deliberately plain text: bold/italic/etc are disabled.
  quote: { canAlign: false, inlineFormats: NONE },
  callout: { canAlign: false, inlineFormats: NONE },
};
