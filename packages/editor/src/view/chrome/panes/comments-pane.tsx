...
export function CommentAddPopover(props: {
  ...
  // The field autofocuses via the overlay authority's focus policy (docs/029 §7.1/R1-G):
  // this form renders as a `form` envelope (selection-bar drill-in / context-menu / ribbon
  // `openForm`), and the layer focuses the first field — no per-form `useAutoFocusWithin`.
